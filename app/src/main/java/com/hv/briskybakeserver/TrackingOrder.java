...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if (mLastLocation!=null)
            {
                ...
                //Add marker in your location and move the screen
                LatLng yourLocation=new LatLng(latitude,longitude);
                mMap.addMarker(new MarkerOptions().position(yourLocation).title("Your Loaction"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(yourLocation));
                mMap.animateCamera(CameraUpdateFactory.zoomTo(17.0f));

                //After add marker to your location, add marker to the order and draw route
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode!=ConnectionResult.SUCCESS)
        {
            ...
            {
                Toast.makeText(this, "It doesn't support", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
